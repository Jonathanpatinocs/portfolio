...
const IconRow = () => {
    return (
        <div className="navbarLogos">
            ...
            <div className="logo"><a href="www.linkedin.com/in/jonathan-patino-5a443b294" target="_blank" rel="noopener noreferrer"><img src={linkedinLogo} alt="LinkedIn link"/></a></div>
        </div>
    )
}
const Navbar = () => {
